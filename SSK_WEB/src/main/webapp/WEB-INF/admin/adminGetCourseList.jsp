                    ...
                    <table id="w-table">
                        ...
                        <c:forEach var="course" items="${courseList}">
                            <tr>
                                ...
                                <td><a class="a-btn" href="/adminGetCourse.do?couseName=${course.courseNum}">${course.courseName}</a></td>
                                <td>${course.courseProfessorNum}</td>
                                <td>${course.courseProfessorName}</td> <!-- 교수자 이름 -->
                                <td>${course.courseProfessorMajor}</td> <!-- 교수자 전공 -->
