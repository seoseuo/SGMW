					...
					<div class="grid-item">
						...
						<table>
							<form id="adminEditUser"
								action="/adminEditProfessor.do?num=${professor.professorNum}"
								method="post">
								<tr>
							...
							<tr>
								<td><b>교수자 소속 (전공): </b> <input class="input-edit-info"
									...
									value="${professor.professorMajor}"> <br> <span
							...
							<tr>
								<td><a href="/adminDeleteProfessor.do?num=${professor.professorNum}" id="deleteButton"> <input type="button"
										value="❌삭제">
								</a></td>
							</tr>
							</form>
